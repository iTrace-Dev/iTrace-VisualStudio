...
namespace iTraceVS {
    ...
    [Guid(itrace_commandPackage.PackageGuidString)]
    [ProvideOptionPage(typeof(OptionPageGrid), "iTrace", "iTrace Settings", 0, 0, true)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    public sealed class itrace_commandPackage : AsyncPackage
    {
        /// <summary>
        /// Command1Package GUID string.
        /// </summary>
        public const string PackageGuidString = "0e754cf2-9558-42dd-ac58-31a16a2dab0a";

        /// <summary>
        /// Initializes a new instance of the <see cref="itrace_commandPackage"/> class.
        /// </summary>
        public itrace_commandPackage() {
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress) {
            ...
            await itrace_toolCommand.InitializeAsync(this);
        }
